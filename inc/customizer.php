<?php
/**
 * WP_Test_Theme Theme Customizer
 *
...
function wp_test_theme_customize_preview_js() {
	wp_enqueue_script( 'wp_test_theme_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
